...
> A montagem do circuito é coincidente ao [Exercício_em_Casa_1](https://github.com/Matheusrammos/LIA-Docs/tree/main/Exerc%C3%ADcio_em_Casa_1). Porém, nesse projeto, optei por usar o modelo pull-dow.
